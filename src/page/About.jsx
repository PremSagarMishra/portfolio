  ...
  return (
    <div className='about'>
      ...
      <div className='container'>
        <div className="left">
        <p className='intro'>Hello! My name is Prem Sagar Mishra, and I enjoy creating things that live on the internet. My interest in web development started back in 2018 when I tried to build software using Java. Since then, I have explored multiple tech domains.<br></br><br></br>
